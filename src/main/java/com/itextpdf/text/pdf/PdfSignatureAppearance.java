/*
 * $Id: 8502d4298311b7f4039326e692ecff76a0c4c6a5 $
 *
...
public class PdfSignatureAppearance {
    ...
    public PdfTemplate getAppearance() throws DocumentException {
        ...
        if (app[2] == null) {
            ...
            if (renderingMode == RenderingMode.NAME_AND_DESCRIPTION || renderingMode == RenderingMode.GRAPHIC_AND_DESCRIPTION && this.signatureGraphic != null) {
                ...
                signatureRect = new Rectangle(MARGIN, MARGIN, rect.getWidth() - MARGIN, // take all space available
     ...
     * @throws DocumentException on error
     */
    public void preClose(HashMap<PdfName, Integer> exclusionSizes, List<Integer> pages) throws IOException, DocumentException {
        if (preClosed)
